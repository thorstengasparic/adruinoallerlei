...
void loop(){
	...
	//pid_p_gain_roll = 10-ValFromRec((float)receiver_input[1], 5, 10);
	//pid_i_gain_roll = ValFromRec((float)receiver_input[2], 5, 10);
	//pid_d_gain_roll = 10-ValFromRec((float)receiver_input[5], 5, 10);
	//Serial.print(receiver_input_channel_5);
	//Serial.print(" ");
	//Serial.print(receiver_input_channel_6);
	//Serial.print(" ");
	//Serial.println(receiver_input_channel_7);
