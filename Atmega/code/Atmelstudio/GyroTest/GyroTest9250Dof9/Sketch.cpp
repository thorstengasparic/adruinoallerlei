...
//  MahonyQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f, my, mx, mz);
    ...
    Serial.print("X-mag field: "); Serial.print(magCount[0]); Serial.print(" mG "); 
    Serial.print("Y-mag field: "); Serial.print(magCount[1]); Serial.print(" mG "); 
    Serial.print("Z-mag field: "); Serial.print(magCount[2]); Serial.println(" mG"); 
...
//
   ...
   //
    ...
    Serial.print(" mz = "); Serial.print( magCount[2]); Serial.println(" mG");
