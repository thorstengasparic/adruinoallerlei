========================================================================
    KONSOLENANWENDUNG: MainConsolAppl-Projektübersicht
========================================================================

Diese MainConsolAppl-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die MainConsolAppl-Anwendung besteht.


MainConsolAppl.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen MainConsolAppl.pch sowie eine vorkompilierte 
