...
#define LEDPIN_STATUS LED_BUILTIN
...
//
			...
			if(loop_counter == 6)Serial.print("\tAccP: ");
			if(loop_counter == 7)Serial.print(angle_pitch_acc);
			if(loop_counter == 8)Serial.print("\tAccR: ");
			if(loop_counter == 9)Serial.print(angle_roll_acc);
			if(loop_counter == 10)Serial.print("\tTotal: ");
			if(loop_counter == 11) Serial.println(acc_total_vector[0]);
