///*
 //* DCM.c
 //*
 //* Created: 13-Jan-13 12:24:23 AM
 //*  Author: M.Hefny
 //* Code is adapted from http://code.google.com/p/picquadcontroller/
 //* please access his DCM article http://www.starlino.com/dcm_tutorial.html
 //*/ 
//#include <avr/io.h>
//#include <stdio.h>
//#include <stdlib.h>
...
////-------------------------------------------------------------------
//float getAcclOutput(uint8_t w)
//{
	//
	//return (float) (Sensors_Latest[w]);
	//
