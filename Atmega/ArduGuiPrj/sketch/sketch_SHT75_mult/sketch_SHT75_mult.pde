...
#include <ctype.h>
#include "stdafx.h"
#include "c:\data\svn\infotek\gat\MainConsolAppl\CppFrame.h"
//#define DATA    3              /* Arduino pin for data read/write */
...
{
    sConnectionReset (dataport);                /* Reset SHT1x communication */
...
void setup()
{
    ...
    Serial.println("3 - 9 : Read in temerature and humidity\n");
}
...
void loop()
{
	...
	{   /* when a serial connection exists */
