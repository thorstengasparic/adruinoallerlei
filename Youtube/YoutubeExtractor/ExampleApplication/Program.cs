...
namespace ExampleApplication
{
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            //const string link = "http://www.redtube.com/1693139";
            const string link = "https://www.youtube.com/watch?v=5PST7Ld4wWU";
            
            
            //RTDownloader rt = new RTDownloader(link, @"c:\tmp\");
            //rt.DownloadProgressChanged += (sender, args) => Console.WriteLine(args.ProgressPercentage+ "% curspeed:"+ args.DownloadSpeed + " totalspeed:" + args.TotalDownloadSpeed);
            //rt.Execute();
